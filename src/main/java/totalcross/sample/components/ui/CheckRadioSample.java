...
public class CheckRadioSample extends BaseScreen {
	...
	public CheckRadioSample () {
		super("https://totalcross.gitbook.io/playbook/components/checkbox");
	}
	...
	public void onContent(ScrollContainer content) {
		try {
			...
			content.add(c2, LEFT + gap, AFTER + gap, FILL - gap, WILL_RESIZE);
...
//					PREFERRED + fmH * 5, area3);
			...
			content.add(new Spacer(), CENTER, AFTER, 10, gap / 2, c2);
