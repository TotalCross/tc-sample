...
public class GaugeSample extends Container {
    ...
    public void initUI() {
        ...
        add(storageGauge, CENTER, TOP, PARENTSIZE + 33, PARENTSIZE + 50);
        ...
        add(stylishSectionsGauge, LEFT, AFTER, PARENTSIZE + 33, PARENTSIZE + 50);

        Gauge energyGauge = new Gauge(0, 80, 180);
        ...
        add(energyGauge, RIGHT, AFTER, PARENTSIZE + 33, PARENTSIZE + 50);
    }
}
