...
public class ImageBookSample extends Container {
	final int gap = fmH / 2;
	Container options;
	GridContainer gc;
	static boolean isVert;
	RadioGroupController rg;
	public static String[] images = { "images/books/book1.png", "images/books/book2.png",
			"images/books/book3.png", "images/books/book4.png",
			"images/books/book5.png", "images/books/book6.png",
			"images/books/book7.png", "images/books/book8.png", };
	...
	private static final int CELL_GAP = 0;// uncomment to change the space - Settings.uiAdjustmentsBasedOnFontHeight ?
											// 20 : 2;
		...
		public void initUI() {
			...
			try {
				...
				if (highQuality) {
					...
					ImageControl ic = new ImageControl(image.getSmoothScaledInstance((int) (image.getWidth() * ratio),
