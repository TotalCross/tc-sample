...
public class ReflectionSample extends BaseScreen {
	private int gap = 50;
	// ui
	...
	public void onContent(ScrollContainer content) {
		try {
			...
			content.add(alc, LEFT + gap, TOP + gap, FILL - gap, PREFERRED);
			...
			content.add(btAdd, CENTER, AFTER + gap*2, SCREENSIZE + 50, PREFERRED +fmH*6);
			Label adv = new Label("Constructed and retrieved using reflection:", CENTER);
			adv.autoSplit = true;
			content.add(adv, LEFT + gap, AFTER + gap);
