  ...
  public void initUI() {
    ...
    add(sideMenu, LEFT, TOP, PARENTSIZE, PARENTSIZE);
  	...
  	private Sub createIOSubGroup() {
  		return new SideMenuContainer.Sub("IO", 
			new SideMenuContainer.Item("File", MaterialIcons._ATTACH_FILE, Color.BLACK, () -> { return new FileSample(); }));
  	}
  	...
  	private Sub createXMLSubGroup() {
  		return new SideMenuContainer.Sub("XML",
  			...
  			new SideMenuContainer.Item("Soap", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new SoapSample(); }));
	}
	...
	private Sub createUISubGroup() {
	   return new SideMenuContainer.Sub("UI",
			   ...
			   new SideMenuContainer.Item("Charts", MaterialIcons. _GRAPHIC_EQ, Color.BLACK,  () -> { return new ChartSample(); }),
			   ...
			   new SideMenuContainer.Item("Switch", MaterialIcons._SLIDESHOW, Color.BLACK,  () -> { return new SwitchSample(); }),	
	...
	private Sub createLangSubGroup() {
		return new SideMenuContainer.Sub("Lang", 
			...
			new SideMenuContainer.Item("Reflection", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new ReflectionSample(); }));
	}

	private Sub createMapSubGroup() {
		return new SideMenuContainer.Sub("Map",
				new SideMenuContainer.Item("Google Maps", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new GoogleMapsSample(); }));
	}
	...
	private Sub createNetSubGroup() {
		return new SideMenuContainer.Sub("Net",
				...
				new SideMenuContainer.Item("Socket", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new SocketSample(); }));
	}

	private Sub createPhoneSubGroup() {
		return new SideMenuContainer.Sub("Phone",
				new SideMenuContainer.Item("Dialer", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new PhoneDialerSample(); }),
				new SideMenuContainer.Item("SMS", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new PhoneSmsSample(); }));
	}

	private Sub createSystemSubGroup() {
		return new SideMenuContainer.Sub("System",
				new SideMenuContainer.Item("Settings", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new SettingsSample(); }),
				new SideMenuContainer.Item("External viewers", MaterialIcons._ART_TRACK, Color.BLACK, () -> { return new ExternalViewersSample(); }));
	}
